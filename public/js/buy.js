var paymentVue = new Vue({
    ...
    data: {
        ...
        steps: 1, //bÆ°á»›c máº¥y
        gates: null, //id cá»•ng thanh toÃ¡n
        desc: "", //mÃ´ táº£ cÃ´ng thanh toÃ¡n
        listMethods: [], //danh sÃ¡ch phÆ°Æ¡ng thá»©c thanh toÃ¡n
        ...
        //step1 , khá»Ÿi táº¡o thÃ´ng tin khÃ¡ch hÃ ng
        customerEmail: userEmail,
        customerName: userName,
        customerPhone: userPhone,
        customerAddress: userAddress,

        //step 2, khá»Ÿi táº¡o thÃ´ng tin ngÆ°á»i nháº­n hÃ ng
        deliveryName: userName,
        deliveryPhone: userPhone,
        deliveryAddress: userAddress,

        //giÃ¡ dáº¡ng yÃªn nháº­t, dÃ nh cho thanh toÃ¡n nháº­t báº£n
        jpyPrice: jpPrice,
        ...
        //thÃ´ng tin Ä‘Æ¡n hÃ ng thÃ nh cÃ´ng
        successInvoice: null,
